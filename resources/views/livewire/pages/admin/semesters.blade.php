<div>
                        ...
                        <tbody>
                            @forelse ($semesters as $semester)
                                <tr>
                                    ...
                                    <td class="text-muted">
                                        {{ $semester->start_month }} - {{ $semester->end_month }}
                                    </td>
                                    <td class="text-muted">
                                    ...
                                    <td>
                                        <button wire:click="edit({{ $semester->id }})" type="button"
                                        ...
                                        <button type="button" wire:click="formDelete({{ $semester->id }})"
    ...
    {{-- modal --}}
    {{-- @include('livewire.pages.admin.form.semester-form') --}}
    {{-- end modal --}}

    {{-- delete --}}
    {{-- @include('livewire.pages.admin.form.delete.semester-delete') --}}
    {{-- delete --}}
</div>
@push('scripts')
    <script>
