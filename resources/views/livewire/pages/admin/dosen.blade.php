<div>
                        ...
                        <tbody>
                            @forelse ($dosen as $do)
                                <tr>
                                    ...
                                    <td>
                                        <button wire:click="edit({{ $do->id }})" type="button"
                                        ...
                                        <button type="button" wire:click="formDelete({{ $do->id }})"
    ...
    {{-- modal --}}
    @include('livewire.pages.admin.form.dosen-form')
    {{-- end modal --}}

    {{-- delete --}}
    @include('livewire.pages.admin.form.delete.dosen-delete')
    {{-- delete --}}
</div>
@push('scripts')
    <script>
