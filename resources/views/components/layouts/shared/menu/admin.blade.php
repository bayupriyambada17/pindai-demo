<ul class="navbar-nav pt-lg-3">
    ...
    <li class="nav-item {{ request()->routeIs('admin.academic-year') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('admin.academic-year') }}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
    ...
    <li class="nav-item  {{ request()->routeIs('admin.lecturer') ? 'active' : '' }}">
        <a class="nav-link"
    ...
    <li class="nav-item {{ request()->routeIs('admin.research') ? 'active' : '' }}">
        <a class="nav-link "
